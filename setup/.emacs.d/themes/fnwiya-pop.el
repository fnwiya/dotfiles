;;; fnwiya-pop.el ---  A color theme for Emacs

;; Copyright (C) 2015  fnwiya

;; Author: fnwiya <fnwiya@gmail.com>
;; Keywords: 
...
(deftheme fnwiya "Fnwiya color theme.")
...
;;;;; anzu
   `(anzu-mode-line ((t (:foreground ,base0D :weight bold))))

   ;; eshell
   `(eshell-prompt ((t (:foreground ,base08 :weight bold))))
   `(eshell-ls-archive ((t (:foreground ,base08 :weight bold))))
   `(eshell-ls-backup ((t (:inherit font-lock-comment-face))))
   `(eshell-ls-clutter ((t (:inherit font-lock-comment-face))))
   `(eshell-ls-directory ((t (:foreground ,base0D :weight bold))))
   `(eshell-ls-executable ((t (:foreground ,base08 :weight bold))))
   `(eshell-ls-unreadable ((t (:foreground ,base06))))
 ...
 ;;;;; auto-complete
   ...
   `(popup-scroll-bar-foreground-face ((t (:background ,base0D))))
   ...
   `(flycheck-warning
     ((((supports :underline (:style wave)))
       (:underline (:style wave :color ,base0A) :inherit unspecified))
      (t (:foreground ,base0A :weight bold :underline t))))
   `(flycheck-info
     ((((supports :underline (:style wave)))
       (:underline (:style wave :color ,base0D) :inherit unspecified))
      (t (:foreground ,base0D :weight bold :underline t))))
   `(flycheck-fringe-error ((t (:foreground ,base08 :weight bold))))
   `(flycheck-fringe-warning ((t (:foreground ,base0A :weight bold))))
   `(flycheck-fringe-info ((t (:foreground ,base0D :weight bold))))
...
(provide-theme 'fnwiya-pop)
;;; fnwiya-pop.el ends here
